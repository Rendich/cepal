        ...
        d3version4.json('data/my_input2.json', (error, root) => {
            ...
            const newSlice = slice.enter()
                ...
                .on('click', d => {
                    ...
                    //if(d.value != d3version4.select("#queryDays2").value){
                    if(d.data.id != d3version4.select("#queryDays2").value){
                      console.log(d)
                      console.log("[376] "+d.data.id +" - "+d.value +" - "+ d3version4.select("#queryDays2").node().value)
                      d3version4.select("#queryDays2").node().value = d.data.id
                      console.log(d3version4.select("#queryDays2").node().value)
...
/*
        ...
        function focusOn(d = { x0: 0, x1: 1, y0: 0, y1: 1 }) {
            ...
            d3version4.select("#queryDays2").on("change", function() {
              var v = this.value;
              console.log(v)
              moveStackToFront(v);
                          function moveStackToFront(elD) {
